(function() {
	...
	appControllers.controller("MainController", ["$scope", "$http", 'Categories', 'Tags', 'CateringFacility', function($scope, $http, Categories, Tags, CateringFacility) {
		$scope.menu = false;
		...
		this.changeTags = function(){
			this.tags = Tags.query({categoryId: $scope.cateringFacility.categoryId});
		}
	...
	appControllers.controller("TagController", ["$scope", 'MenuTag', function($scope, MenuTag) {
