...
INSERT INTO category (id, name) VALUES (1, 'restaurace'), (2, 'rychlé občerstvení'), (3, 'potraviny');
...
INSERT INTO catering_facility(
            ...
            longitude, menufrom, menuto, menuurl, name, street, url, creator_id)
    VALUES (1, 'Praha', 'Dejvice', 'Skvělé pivo a tlačenka.', 123, 50.101500, 
            14.390791, null, null, null, 'U studny', 'street', 'www.ustudny.cz', 274),
	   (2, 'Praha', 'Dejvice', 'Skvělé pivo.', 123, 50.102246, 
            14.392576, null, null, null, 'Pražská pivnice', 'street', 'www.prazska-pivnice.cz', 274);

INSERT INTO catering_facility_categories(facility_id, category_id)
    VALUES (1, 1),
	  (2, 2);
